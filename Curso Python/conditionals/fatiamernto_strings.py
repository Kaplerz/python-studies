...
print(variavel[0:len(variavel):2])# essa é o teste da função P - passo que determina de quantos em quantos caracteres ela vai pular, ela ja vem como padrao de 1 e dessa maneira vai retornar ( Ola mundo) normalmente
